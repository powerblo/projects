...
ws = "/home/hanse/workspace/projects/24q2-study/w2/"
...
class Model(nn.Module):
    def __init__(self):
        super().__init__()
        self.poly = nn.Parameter(torch.rand(3)) # deg 4 poly

    def network(self, z):
        return 1 + self.poly[0] * z + \
               self.poly[1] * z**2 + self.poly[2] * z**3 + \
               (-1-self.poly[0]-self.poly[1]-self.poly[2])*z**4
...
# figures
savedir = '/home/hanse/workspace/projects/24q2-study/linearode/'
